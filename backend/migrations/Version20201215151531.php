 ...
 */
final class Version20201215151531 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list CHANGE active active TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list CHANGE active active TINYINT(1) DEFAULT NULL');
    }
}
